<template>
    <div  class="flex items-center justify-between w-full  h-[10vh] text-white shadow-xl bg-gradient-to-b from-[rgba(0,0,0,.75)] to-[rgba(0,0,0,1)]">
        <div @click="homeLoad" class="ms-5  text-4xl font-news hover:cursor-pointer">NBCNNBC</div>
        ...
        <div @click="(e) => {e.stopPropagation()}"  class=" me-5  text-4xl text-right hover:cursor-pointer"><i @click="toggleDropDown()" class="fa-solid fa-bars"></i></div>
    </div>
        ...
        <div class="flex w-[95%] h-[86.25%] text-white">
            <div class=" h-full w-1/3 flex items-center justify-center">
                <div class=" w-[80%] h-full flex flex-col gap-y-20 pt-10 items-start ps-20">
                    <h2 @click="goToCategoryPage('general')" class="text-4xl hover:cursor-pointer">General</h2>
                    <h2 @click="goToCategoryPage('business')" class="text-4xl hover:cursor-pointer">Business</h2>
                    <h2 @click="goToCategoryPage('entertainment')" class="text-4xl hover:cursor-pointer">Entertainment</h2>
                </div>
            </div>
            <div class="h-full w-1/3 flex items-center justify-center">
                <div class=" w-[80%] h-full flex flex-col gap-y-20 pt-10 items-start ps-24">
                    <h2 @click="goToCategoryPage('health')" class="text-4xl hover:cursor-pointer">Health</h2>
                    <h2 @click="goToCategoryPage('science')" class="text-4xl hover:cursor-pointer">Science</h2>
                    <h2 @click="goToCategoryPage('sports')" class="text-4xl hover:cursor-pointer">Sports</h2>
                </div>
            </div>
            <div class="h-full w-1/3 flex items-center justify-center">
                <div class="w-[80%] h-full flex flex-col gap-y-20 pt-10 items-center">
                    <h2 @click="goToCategoryPage('technology')" class="text-4xl hover:cursor-pointer">Technology</h2>  
                </div>
            </div> 
        </div>
    </div>
